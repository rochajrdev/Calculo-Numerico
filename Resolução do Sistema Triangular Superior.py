def resolver_sistema_triangulo_superior(A, b):
    """
    Resolve um sistema linear triangular superior Ax = b e imprime os passos detalhados.

    Parâmetros:
    A (list of lists): Matriz triangular superior.
    ...
    print("=== Resolução do Sistema Triangular Superior ===")
    ...
    for i in range(n-1, -1, -1):
        print(f"Passo {n-i}: Resolvendo para a variável x[{i}]")
...
A = [
    ...
    [0, 3, 2],   # Coeficientes da segunda equação: 3x1 + 2x2 = 7
    [0, 0, 1]    # Coeficiente da terceira equação: x2 = 3
]
b = [5, 7, 3]  # Termos independentes correspondentes às equações acima

# Chamando a função para resolver o sistema e imprimir os passos
solucao = resolver_sistema_triangulo_superior(A, b)